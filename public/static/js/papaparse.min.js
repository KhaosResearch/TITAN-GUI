        ...
        if (((t.dynamicTyping = r), (t.transform = !!q(t.transform) && t.transform), t.worker && b.WORKERS_SUPPORTED)) {
          var i = (function () {
            ...
            var e =
                ...
                (i = s.toString()),
                b.BLOB_URL ||
                  (b.BLOB_URL = r.createObjectURL(new Blob(["(", i, ")();"], { type: "text/javascript" })))),
              t = new f.Worker(e);
            var r, i;
        ...
        function u(e, t, r) {
          ...
          for (var o = 0; o < t.length; o++) {
            ...
            if (
              (r &&
                !n &&
                (u = "greedy" === r ? "" === t[o].join("").trim() : 1 === t[o].length && 0 === t[o][0].length),
              "greedy" === r && n)
            ) {
              for (var d = [], l = 0; l < h; l++) {
                var c = s ? e[l] : l;
      ...
      (this._chunkLoaded = function () {
        4 === i.readyState &&
          (i.status < 200 || 400 <= i.status
            ? this._chunkError()
            : ((this._start += i.responseText.length),
              (this._finished =
  ...
  function c(e) {
    ...
    (this.stream = function (e) {
      (this._input = e),
        ...
        s
          ? (((i = new FileReader()).onload = y(this._chunkLoaded, this)), (i.onerror = y(this._chunkError, this)))
  ...
  function r(g) {
    ...
    (this.parse = function (e, t, r) {
      ...
      if (
        ...
        n.successful ? (g.delimiter = n.bestDelimiter) : ((h = !0), (g.delimiter = b.DefaultDelimiter)),
    ...
    (this.parse = function (a, r, t) {
      ...
      if (F || (!1 !== F && -1 === a.indexOf(O))) {
        for (var l = a.split(I), c = 0; c < l.length; c++) {
          if (((f = l[c]), (z += f.length), c !== l.length - 1)) z += I.length;
          else if (t) return R();
          if (!T || f.substr(0, s) !== T) {
            if (o) {
          ...
          for (g = z, z++; ; ) {
            ...
            if (O !== M || a[g + 1] !== M) {
              if (O === M || 0 === g || a[g - 1] !== M) {
                ...
                if (a[g + 1 + y] === D) {
                  f.push(a.substring(z, g).replace(_, O)),
                    a[(z = g + 1 + y + e)] !== O && (g = a.indexOf(O, z)),
                    (p = a.indexOf(D, z)),
                    (m = a.indexOf(I, z));
                  break;
                }
    ...
    if (t.error) r.userError(t.error, t.file);
      ...
      if (q(r.userStep)) {
        for (
          ...
          (r.userStep({ data: t.results.data[s], errors: t.results.errors, meta: t.results.meta }, n), !i);
          s++
        );
        delete t.results;
